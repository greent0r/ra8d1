...
static StaticTask_t blinky_thread_memory;
                ...
                static uint8_t blinky_thread_stack[16384] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
static uint8_t blinky_thread_stack[16384] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.blinky_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
#endif
#endif
...
void blinky_thread_create(void)
{
    ...
    blinky_thread = xTaskCreateStatic (
                    ...
                    #endif
                                       blinky_thread_func,
                                       (const char*) "blinky Thread", 16384 / 4, // In words, not bytes
