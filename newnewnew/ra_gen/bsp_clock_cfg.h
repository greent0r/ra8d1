...
#define BSP_CFG_PLL_MUL BSP_CLOCKS_PLL_MUL(160,0) /* PLL Mul x160-180|Mul x160|Mul x160.00 */
...
#define BSP_CFG_UCK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1R) /* UCK Src: PLL1R */
