...
//内存池(32字节对齐)
uint8_t membase[MEM_MAX_SIZE] BSP_ALIGN_VARIABLE(64) BSP_PLACE_IN_SECTION(".sdram");
uint32_t mapbase[MEM_ALLOC_TABLE_SIZE] BSP_ALIGN_VARIABLE(64) BSP_PLACE_IN_SECTION(".sdram");
