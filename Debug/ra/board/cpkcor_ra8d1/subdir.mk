...
C_SRCS += \
../ra/board/cpkcor_ra8d1/board_init.c \
../ra/board/cpkcor_ra8d1/board_leds.c 

C_DEPS += \
./ra/board/cpkcor_ra8d1/board_init.d \
./ra/board/cpkcor_ra8d1/board_leds.d 

CREF += \
newnewnew.cref 

OBJS += \
./ra/board/cpkcor_ra8d1/board_init.o \
./ra/board/cpkcor_ra8d1/board_leds.o 
...
ra/board/cpkcor_ra8d1/%.o: ../ra/board/cpkcor_ra8d1/%.c
	@echo 'Building file: $<'
