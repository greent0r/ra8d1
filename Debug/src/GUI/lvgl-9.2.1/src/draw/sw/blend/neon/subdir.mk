...
S_UPPER_SRCS += \
../src/GUI/lvgl-9.2.1/src/draw/sw/blend/neon/lv_blend_neon.S 

CREF += \
newnewnew.cref 

OBJS += \
./src/GUI/lvgl-9.2.1/src/draw/sw/blend/neon/lv_blend_neon.o 

MAP += \
newnewnew.map 

S_UPPER_DEPS += \
./src/GUI/lvgl-9.2.1/src/draw/sw/blend/neon/lv_blend_neon.d 


# Each subdirectory must supply rules for building sources it contributes
src/GUI/lvgl-9.2.1/src/draw/sw/blend/neon/%.o: ../src/GUI/lvgl-9.2.1/src/draw/sw/blend/neon/%.S
	@echo 'Building file: $<'
